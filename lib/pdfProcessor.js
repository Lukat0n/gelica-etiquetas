...
async function drawStrip(page, combo, stripPct = 0.95) {
...
export async function processPDF(arrayBuffer, sortByProduct = false, products = DEFAULT_PRODUCTS, credentials = null, stripPct = 0.95) {
  ...
  for (const label of labels) {
    ...
    await drawStrip(pages[pages.length - 1], label.combo, stripPct);
  }
